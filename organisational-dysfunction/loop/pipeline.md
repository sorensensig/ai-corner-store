...
- Commit and push. If you updated an existing PR's branch, add a PR comment naming what was appended; if you opened a new PR, describe which dysfunctions were added and credit the source series. **Then verify** the remote PR's changed-file list actually includes the new reference files before reporting success.
