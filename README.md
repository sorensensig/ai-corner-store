...
|---|---|---|
| [`organisational-dysfunction`](./organisational-dysfunction) | Diagnose org & team dysfunction as a problem of structure, not people — 66 named dysfunctions read through open sociotechnical systems theory. | `organisational-dysfunction` |
