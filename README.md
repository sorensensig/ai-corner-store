...
|---|---|---|
| [`organisational-dysfunction`](./organisational-dysfunction) | Diagnose org & team dysfunction as a problem of structure, not people — 68 named dysfunctions read through open sociotechnical systems theory. | `organisational-dysfunction` |
...
| [`designsystemet`](./designsystemet) | Build with Digdir's Designsystemet correctly on the first attempt — quote-verified component contracts (twins), a WCAG guard hook, MCP twins server, and the `/ds-check` audit. Interim home; moves to kihub. | `designsystemet` |
| _more coming_ | | |
